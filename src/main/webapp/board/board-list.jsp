...
<body>
	...
	<form>
		...
		<input type="text" placeholder="작성자" name="biWriter" id="biWriter"
			value="<%=request.getParameter("biWiter") == null ? "" : request.getParameter("biWriter")%>">
	...
	<table border="1">
		...
		<tr>
			...
			<td><a
				href="<%=root%>/board/board-view.jsp?biNum=<%=rs.getInt("BI_NUM")%>">
		...
		<tr>
			<td colspan="6" align="right">
				<button onclick="location.href='/web/board/board-insert.jsp'">submit</button>
			</td>
		</tr>
